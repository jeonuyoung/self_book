...
Vvveb.Components.add("components/product", {
    ...
    image: "./resources/libs/builder/icons/map.svg",
...
Vvveb.Components.add("components/products", {
    ...
    image: "./resources/libs/builder/icons/products.svg",
...
Vvveb.Components.add("components/manufacturers", {
    ...
    image: "./resources/libs/builder/icons/categories.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        nolabel:true,
        inputtype: TextInput,
...
Vvveb.Components.add("components/search", {
    ...
    image: "./resources/libs/builder/icons/search.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/user", {
    ...
    image: "./resources/libs/builder/icons/user.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product_gallery", {
    ...
    image: "./resources/libs/builder/icons/product_gallery.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/cart", {
    ...
    image: "./resources/libs/builder/icons/cart.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/checkout", {
    ...
    image: "./resources/libs/builder/icons/checkout.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/filters", {
    ...
    image: "./resources/libs/builder/icons/filters.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product", {
    ...
    image: "./resources/libs/builder/icons/product.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/slider", {
    ...
    image: "./resources/libs/builder/icons/slider.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
