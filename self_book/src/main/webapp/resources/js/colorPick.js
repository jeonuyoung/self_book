...
(function( $ ) {
    ...
    $.colorPick.prototype = {
        ...
        show: function(left, top) {
            $("#colorPick").remove();
           // var ser = document.getElementById('iframe1').contentWindow.document
            $("#extension").append('<div id="colorPick" style="display:none;top:' + top + 'px;left:' + left + 'px"><span>'+$.fn.colorPick.defaults.paletteLabel+'</span></div>');
